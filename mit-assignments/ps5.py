...
def update_hand(hand, word):
    ...
    for letter in word:
        ...
        if letter in duplicaate_hand:
            duplicaate_hand[letter] -= 1

            if duplicaate_hand[letter] == 0:
                del duplicaate_hand[letter] 
    
    print(duplicaate_hand)
...
def is_valid_word(word, hand, word_list):
    ...
    for letter in word:
        if duplicate_hand[letter] == 0:
            return False
        else:
            duplicate_hand[letter] -= 1
...
def calculate_hand_len(hand):
    """
    Calculates the total number of letters in the hand.
    """
